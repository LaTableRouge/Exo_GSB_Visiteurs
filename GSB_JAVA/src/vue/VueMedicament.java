...
public class VueMedicament extends VueAbstraite
{
    ...
    public JTextArea getTxtEffets() 
    {
        return txtEffets;
    }

    public void setTxtEffets(JTextArea txtEffets)
    {
        this.txtEffets = txtEffets;
    }

    public JTextArea getTxtContreIndic()
    {
        return txtContreIndic;
    }

    public void setTxtContreIndic(JTextArea txtContreIndic) 
    {
    ...
    private void initComponents() {
        ...
        txtEffets.setRows(5);
        jScrollPane1.setViewportView(txtEffets);
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(90, 120, 620, 490);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(340, 40, 148, 31);
