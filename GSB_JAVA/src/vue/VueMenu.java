...
public class VueMenu extends VueAbstraite
{
   ...
   /**
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(190, 100, 613, 500);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(370, 50, 300, 31);
    ...
    //évènement sur le bouton visiteur qui va chercher la méthode menuVisiteur dans le controleur pour afficher la vue visiteur
    ...
    //évènement sur le bouton praticiens qui va chercher la méthode menuPraticiens dans le controleur pour afficher la vue praticiens
    ...
    //évènement sur le bouton compte-rendus qui va chercher la méthode menuRapportsVisite dans le controleur pour afficher la vue compte-rendus
