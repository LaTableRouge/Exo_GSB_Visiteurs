 ...
 * Objectif : 
 * - dynamique Vue/Controleur avec controleur principal
 * - pattern Dao
 * - singleton de connexion à un SGBD
 * - paramétrage utilisant un fichier de "properties"
 */
public class Main 
{
