...
public class CtrlVisiteur extends CtrlAbstrait
{
    ...
    //test si la fonction chargerListeVisiteurs fonctionne sinon un message d'erreur est affiché
    ...
    //Bouton précédent enlève - 1 a chaque utilisateur 
     ...
     * à partir de la base de données (DaoVisiteur)
     *
     * @throws DaoException
     */
    ...
    /**
     * visiteurSelectionner : renseigne la valeur dans chaque champ
